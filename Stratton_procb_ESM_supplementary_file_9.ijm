...
print(Msg);
Emptypath = File.openDialog("Choose empty video file"); //  Select empty video for calibration
...
arenaWidth = width;
arenaHeight = height;
Msg="Parameters for cropping... x: "+arenaX+", y: "+arenaY+", width: "+arenaWidth+", height: "+arenaHeight;
print(Msg);
run("Select None");
close();
